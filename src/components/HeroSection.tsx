          ...
          <div className="flex items-center justify-between h-16 lg:h-[72px]">
            ...
            <div className="hidden lg:flex lg:items-center lg:ml-16 xl:ml-24 lg:space-x-8">
              <a
                href="#"
                title=""
                className="text-sm sans font-medium text-gray-900 transition-all duration-200 rounded hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900"
              >
                {" "}
                Home{" "}
              </a>
