        ...
        <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-6xl py-24 sans">
            <div>
                ...
                <div className="mt-8">
                    <h2 className="text-light text-2xl font-light title ">Email</h2>
                            ...
                            <a href="javascript:void(0)" className="text-sm text-green mt-4 font-light">
                    ...
                    <ul className="flex mt-4 space-x-4">
                        <li className="bg-light h-10 w-10 rounded-full flex items-center justify-center shrink-0">
                            <a href="javascript:void(0)">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" className="fill-green"
                                    viewBox="0 0 24 24">
                                    <path
            ...
            <form className="ml-auto space-y-4">
                <input type='text' placeholder='Name'
                    className="w-full rounded-md py-3 px-4 bg-gray-100 bg-light text-light text-sm outline-green focus:bg-transparent" />
                <input type='email' placeholder='Email'
                    className="w-full rounded-md py-3 px-4 bg-gray-100 bg-light text-light text-sm outline-green focus:bg-transparent" />
                <input type='text' placeholder='Subject'
                    className="w-full rounded-md py-3 px-4 bg-gray-100 bg-light text-light text-sm outline-green focus:bg-transparent" />
                <textarea placeholder='Message' 
                    className="w-full rounded-md px-4 bg-gray-100  bg-light text-light text-sm pt-3 outline-green focus:bg-transparent"></textarea>
                <button type='button'
                    className="text-white bg-green  tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6">Send</button>
            </form>
            </div>
            </div>
    )
