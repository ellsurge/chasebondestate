    ...
    <div id="contact" className="bg-dark">
      <div className="grid sm:grid-cols-2 items-start gap-16 p-4 mx-auto max-w-6xl py-24 sans">
        <div>
          ...
          {/* <div className="mt-8">
            ...
            <a
              ...
              className="text-sm text-green mt-4 font-light"
            >
              info@example.com
            </a>
          </div> */}
        ...
        <form className="ml-auto space-y-4">
          ...
          <textarea
            placeholder="Message"
            className="w-full rounded-md px-4 bg-gray-100  bg-light text-light text-sm pt-3 outline-green focus:bg-transparent"
          ></textarea>
          <button
            type="button"
            className="text-white bg-green  tracking-wide rounded-md text-sm px-4 py-3 w-full !mt-6"
          >
            Send
          </button>
        </form>
